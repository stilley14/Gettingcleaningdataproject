...
##Part 1 of Assignment. Merge the training and the test sets to create one data set.
...
#Part 2 of Assignment. Extracts only the measurements on the mean and standard deviation for each measurement.
...
# Part 4 of Assignment. Appropriately labels the data set with descriptive names.
